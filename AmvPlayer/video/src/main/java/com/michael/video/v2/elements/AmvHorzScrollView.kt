...
//    }
     ...
     */
//    fun hitTest(x:Float) : AmvSliderView.Knob {
//        return when {
//            !trimmingEnabled -> AmvSliderView.Knob.NONE
//            hitTestSub(x, models.leftMaskPixel-models.scrollPixel) -> AmvSliderView.Knob.LEFT
//            hitTestSub(x, models.rightMaskPixel-models.scrollPixel) -> AmvSliderView.Knob.RIGHT
//            else -> AmvSliderView.Knob.NONE
//        }
//    }
